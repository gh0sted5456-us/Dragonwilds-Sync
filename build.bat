...
title Dragonwilds Sync 2.7.15 - Portable Build

echo ============================================================
echo   Dragonwilds Sync 2.7.15 - Portable Windows Build
echo ============================================================
echo Project:   %CD%
...
echo ============================================================
echo Output: "%CD%\release\Dragonwilds Sync and Launcher-Portable-2.7.15.exe"
echo Log:    "%BUILD_LOG%"
echo.
