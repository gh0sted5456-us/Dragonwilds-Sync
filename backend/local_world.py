...
def default_singleplayer_profile(profile_id: str = SINGLEPLAYER_ID, name: str = "SinglePlayer") -> dict:
    ...
    return {
        ...
        "unit_overrides": {},
        "broadcast_config": {"password": "", "server_key": "", "share_access_key": "", "sync_port": 27051, "lan_broadcast": True,
                             "tls_enabled": False, "allow_tls_password_fallback": False, "tls_cert_fingerprint": "", "access_policy": default_access_policy()},
