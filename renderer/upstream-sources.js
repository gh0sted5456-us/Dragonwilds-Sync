(() => {
  ...
  const fallback = {
    ...
    sources: {
      ...
      dragonconnect: { display_name:'DragonLink', enabled:true, type:'bundled-native-suite', bundled_fallback:'resources/NativeRuntimeMods/DragonLink', runtime_component:true, runtime_roles:['server','host','client'] },
