...
def main() -> None:
    with tempfile.TemporaryDirectory() as raw:
        ...
        try:
            ...
            cached_alpha = snapshot / "mods" / "Binaries/Win64/ue4ss/Mods" / "Alpha"
            cached_beta = snapshot / "mods" / "Binaries/Win64/ue4ss/Mods" / "Beta"
            ...
            assert (snapshot / "mods" / "Binaries/Win64/ue4ss/Mods/RuneSchema/mods" / "Gamma" / "recipe.json").is_file()
        finally:
        ...
        try:
            ...
            server_snapshot_beta = server_profile_root / "Profile/Mods/Binaries/Win64/ue4ss/Mods" / "Beta" / "main.lua"
            ...
            assert (server_profile_root / "Profile/Mods/Binaries/Win64/ue4ss/Mods" / "Alpha" / "main.lua").read_text(encoding="utf-8") == "return 'alpha-v2'\n"
        finally:
