...
if (!loader.includes('app-v2.js?v=3.0.4-connected-profile-isolation')) throw new Error('app-v2 cache key was not advanced.');
if (!index.includes('app.js?v=3.0.4-connected-profile-isolation')) throw new Error('app loader cache key was not advanced.');
