...
title Dragonwilds Sync 2.6.0 - Portable Build

echo ============================================================
echo   Dragonwilds Sync 2.6.0 - Portable Windows Build
echo ============================================================
echo Project:   %CD%
...
echo ============================================================
echo Output: "%CD%\release\Dragonwilds Sync and Launcher-Portable-2.6.0.exe"
echo Log:    "%BUILD_LOG%"
echo.
