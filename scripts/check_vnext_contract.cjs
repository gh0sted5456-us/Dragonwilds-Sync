...
must(vnext.includes('directory_verified') && vnext.includes('fingerprint_claimed') && vnext.includes('last_seen'), 'Declared semantics must require verified live heartbeat evidence');
