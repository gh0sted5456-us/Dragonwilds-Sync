    ...
    <div class="download-flip-inner">
      <section class="download-face main" aria-label="Desktop application downloads" aria-hidden="false">
        ...
        <div class="download-face-side">
          <div class="download-platform-icons" aria-label="Supported platforms"><img src="assets/platforms/windows.svg" alt="Windows"><img src="assets/distros/ubuntu.svg" alt="Ubuntu Linux"><img src="assets/platforms/steam.svg" alt="Steam"></div>
          ...
          <div class="download-platform-actions">
            ...
            <a class="button button-full linux-download ubuntu-download" data-linux-download download href="https://github.com/gh0sted5456-us/Dragonwilds-Sync/releases/download/v2.0.1/Dragonwilds.Sync.and.Launcher-Ubuntu-2.0.1.AppImage"><span><img src="assets/distros/ubuntu.svg" alt="" aria-hidden="true"><b>Ubuntu Linux</b><small>AppImage</small></span><span aria-hidden="true">↓</span></a>
