...
const crossPlatformTests = [
  'backend/test_remote_user_permissions.py','backend/test_service_subprocess_protocol.py','backend/test_profile_cache_authority.py','backend/test_state_read_durability.py',
