...
title Dragonwilds Sync 3.0.2 - Portable Build

echo ============================================================
echo   Dragonwilds Sync 3.0.2 - Portable Windows Build
echo ============================================================
echo Project:   %CD%
...
echo ============================================================
echo Output: "%CD%\release\Dragonwilds Sync and Launcher-Portable-3.0.2.exe"
echo Log:    "%BUILD_LOG%"
echo.
