(() => {
  ...
  async function enhanceChangelog(root = document) {
    ...
    section.innerHTML='<div class="panel-header"><div><h2>V3 Changelog</h2><span class="panel-subtitle">The single authoritative V3 release record updates from GitHub without requiring a new launcher build.</span></div><button class="btn ghost compact-btn" data-open-changelog-page>Open Full Changelog</button></div><div data-changelog-body class="empty-state">Loading current release notes…</div>';
