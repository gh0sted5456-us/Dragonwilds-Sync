(() => {
  ...
  function combineServerManagement(root=document){const settings=root.querySelector('[data-webhost-tab="settings"]');if(settings)settings.textContent='Website & Networking';root.querySelectorAll('[data-webhost-tab="remote"]').forEach(b=>b.classList.remove('rc2-retired'))}
