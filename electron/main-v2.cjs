  ...
  if (process.env.DWS_HELP_CAPTURE_DIR && !app.isPackaged) {
    mainWindow.webContents.once('did-finish-load', async () => {
      ...
      try {
        ...
        await click('[data-route="characters-app"]');await assertAppyNavigation(); await shot('52-character-tools.png');
